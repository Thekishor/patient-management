...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props){
        ...
        CfnHealthCheck patientServiceHealthCheck =
        ...
        FargateService authService =
                createFargateService("AuthService",
                        ...
                        List.of(4003),
                        authServiceDb,
                        Map.of("JWT_SECRET", "VGhpc0lzQVNlY3VyZVNlY3JldEtleUluQmFzZTY0Rm9ybWF0"));
    ...
    private FargateService createFargateService(
        ...
        envVars.put("SPRING_KAFKA_BOOTSTRAP_SERVER",
    ...
    private void createApiGatewayService(){
        FargateTaskDefinition taskDefinition = FargateTaskDefinition
                .Builder.create(this, "ApiGateway")
                .cpu(256)
                .memoryLimitMiB(512)
                .build();
        ...
        ContainerDefinitionOptions containerOption =
                ContainerDefinitionOptions.builder()
                        ...
                        .environment(Map.of(
                                ...
                                "AUTH_SERVICE_URL", "http://lost.docker.internal:4003"
                        ))
